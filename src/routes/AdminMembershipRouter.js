...
AdminRouterMembership.delete("/delete/:id", membershipController.deleteMembership);
AdminRouterMembership.patch("/restore/:id", membershipController.restoreMembership);
